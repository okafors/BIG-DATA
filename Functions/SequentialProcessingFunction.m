function  [NumHour] = SequentialProcessingFunction(FileName, StartHour, EndHour, StartSet, EndSet);
...
firstHour = 1
lastHour = 5
for NumHour = firstHour:lastHour % loop through each hour
    ...
    t2 = t1;
    StartSet = 1
    for EndSet = [200,1000,10000]   % loops through each number of data provided
    for idx = StartSet: EndSet % step through each data location to process the data
