function  [returntime] = ParallelProcessingFunction(FileName, StartHour, EndHour, StartSet, EndSet, NumWorkers)
...
%% Parallel Analysis
    ...
    for PoolSize = [1:8;] ; % define the number of processors to use in parallel
...
%     % 'DataQ'. See end of script for the function definition.
    ...
    StartSet = 1;
    EndSet = 5000;
    parfor idx = StartSet : EndSet % size(Data2Process,1)
